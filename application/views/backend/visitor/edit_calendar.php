...
<div class="row">
                    <div class="col-sm-12">
					  ...
					  <div class="panel-wrapper collapse in" aria-expanded="true">
								...
								<?php 
								foreach($toSelectFromCalendarWithId as $row) : ?>
                    <?php
                     echo form_open(base_url() . 'patient/appointment/edit/'. $row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
