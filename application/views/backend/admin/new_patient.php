...
<div class="panel panel-info">
                ...
                <?php echo form_open(base_url() . 'admin/new_patient/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="session"  value="<?php echo $this->db->get_where('settings', array('type' => 'session'))->row()->description; ?>" readonly="true">
                    ...
                    <div class="col-sm-12">
							<select name="group_id" class="form-control select2" style="width:100%"id="group_id"
								data-message-required="<?php echo get_phrase('value_required');?>"
									onchange="return get_group_sub_group(this.value)">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <?php
								$groups = $this->db->get('group')->result_array();
		...
		<a href="<?php echo base_url();?>admin/groups/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
 ...
 <div class="form-group">
			...
			<button type="submit" class="btn btn-success btn-sm btn-rounded btn-block"> <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('save_patient');?></button>
