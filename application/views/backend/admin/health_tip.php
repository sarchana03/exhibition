<div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-info">
							...
							HEALTH TIPS
                                ...
                                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW HEALTHTIP HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
                            </div>
               ...
               <div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
							<button type="submit" class="btn btn-success btn-block btn-sm btn-rounded"> <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_health');?></button>
					</div>
					<br>
                <?php echo form_close();?>	
...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    ...
    <?php $counter = 1; $health = $this->db->get('health')->result_array();
            ...
            <tr>
                ...
                <td><?php echo $this->db->get_where('doctor', array('doctor_id' => $health['patient_id']))->row()->name;?></td>
