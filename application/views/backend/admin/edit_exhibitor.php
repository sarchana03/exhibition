<?php
$edit_exhibitor		=	$this->db->get_where('exhibitor' , array('exhibitor_id' => $param2) )->result_array();
foreach ( $edit_exhibitor as $key => $row):
?>
            ...
            <div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('edit_exhibitor');?></div>

                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                    <?php echo form_open(base_url() . 'admin/exhibitor/update/'. $row['exhibitor_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
