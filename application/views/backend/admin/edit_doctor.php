<?php
$edit_doctor		=	$this->db->get_where('doctor' , array('doctor_id' => $param2) )->result_array();
foreach ( $edit_doctor as $key => $row):
?>
            ...
            <div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('edit_doctor');?></div>

                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                    <?php echo form_open(base_url() . 'admin/doctor/update/'. $row['doctor_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="col-sm-12">
							<select name="role" class="form-control select2" required>
                                    	<option value="1" <?php if($row['role'] == '1')echo 'selected';?>><?php echo get_phrase('eye specialist');?></option>
					...
					<div class="form-group">
					 ...
					 <div class="col-sm-12">
       				 ...
       				 <img id="blah" src="<?php echo $this->crud_model->get_image_url('doctor',$row['doctor_id']);?>" alt="" height="200" width="200"/>
...
<div class="form-group">
<button type="submit" class="btn btn-success btn-block btn-rounded btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('update_doctor');?></button>
</div>
                <?php echo form_close();?>
</div>
</div>
