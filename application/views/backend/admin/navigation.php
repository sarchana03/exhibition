    ...
    <?php endif;?> -->
     ...
     <?php if($check_admin_permission == '1'):?>
        <!-- <li> <a href="javascript:void(0);" class=""><i class="fa fa-calendar" data-icon="7"></i> <span class="hide-menu"> <?php echo get_phrase('Appointment Schedule');?> <span class="fa arrow"></span></span></a>
            ...
            //         $page_name == 'doctors_list') echo 'opened active';
            ?> "> -->
    ...
    <?php if($check_admin_permission == '1'):?>
        ...
        <!-- <li class="staff"> <a href="javascript:void(0);" class=""><i data-icon="&#xe006;" class="fa fa-angle-double-right p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Manage Employees');?><span class="fa arrow"></span></span></a>
            ...
            //         $page_name == 'accountant'|| $page_name == 'doctor'||
            //         $page_name == 'hostel')
            //     echo 'opened active';
            ?> "> -->
            ...
            <!-- <li class="<?php if ($page_name == 'doctor') echo 'active'; ?> ">
    ...
    <?php if($check_admin_permission == '1'):?>
        ...
        <!-- <li class="patient"> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-users p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_patients');?><span class="fa arrow"></span></span></a>
                        ...
                        <ul class=" nav nav-second-level<?php
            // if ($page_name == 'new_patient' ||
            //         $page_name == 'patient_class' ||
            //         $page_name == 'patient_information' ||
            //         $page_name == 'view_patient' ||
            //         $page_name == 'searchpatient')
            //     echo 'opened active has-sub';
            ?> "> -->
                    ...
                    <!-- <li class="<?php if ($page_name == 'new_patient') echo 'active'; ?> ">
                        ...
                        <i class="fa fa-angle-double-right p-r-10"></i>
                              <span class="hide-menu"><?php echo get_phrase('patient_login_form'); ?></span>
                        </a>
                    </li> -->

                    <li class="<?php if ($page_name == 'new_visitor') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>admin/new_visitor">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                              <span class="hide-menu"><?php echo get_phrase('Add_visitor'); ?></span>
                        </a>
                    </li>



                     <!-- <li class="<?php if ($page_name == 'patient_information' || $page_name == 'patient_information' || $page_name == 'view_patient') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>admin/patient_information">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                              <span class="hide-menu"><?php echo get_phrase('list_patients'); ?></span>
                        </a>
                    </li>


    <li class="<?php if ($page_name == 'patientCategory') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>patientcategory/patientCategory">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                             <span class="hide-menu"><?php echo get_phrase('patient Categories'); ?></span>
                        </a>
     </li> -->

     <!-- <li class="<?php if ($page_name == 'patientHouse') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>patienthouse/patientHouse">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                             <span class="hide-menu"><?php echo get_phrase('patient House'); ?></span>
                        </a>
     </li>
     ...
     <li class="<?php if ($page_name == 'clubActivity') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>activity/clubActivity">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                             <span class="hide-menu"><?php echo get_phrase('patient Activity'); ?></span>
                        </a>
     </li>
    ...
    <?php if($check_admin_permission == '1'):?>
        ...
        <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-download p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('download_page');?><span class="fa arrow"></span></span></a>
    ...
    <!---  Permission for Admin Manage Alumni ends here ------>
        ...
        <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('class_information');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
                ...
                <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Group_information');?><span class="fa arrow"></span></span></a> -->
        ...
        ?>"> -->
                     ...
                     <!-- <li class="<?php if ($page_name == 'group') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>admin/groups">
                    <i class="fa fa-angle-double-right p-r-10"></i>
                       <span class="hide-menu"><?php echo get_phrase('manage_groups'); ?></span>
                    </a>
                </li>


                <li class="<?php if ($page_name == 'sub_group') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>admin/sub_group">
                    <i class="fa fa-angle-double-right p-r-10"></i>
                        <span class="hide-menu"><?php echo get_phrase('manage_sub_groups'); ?></span>
                    </a>
                </li> -->
         ...
         <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-medkit p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_exams');?><span class="fa arrow"></span></span></a>
        ...
        ?>">
           ...
           <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('report_cards');?><span class="fa arrow"></span></span></a>
        ...
        <!-- <li class="collect_fee"> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-paypal p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('fee_collection');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
                 ...
                 <li class="<?php if ($page_name == 'student_payment') echo 'active'; ?> ">
                    ...
                    <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-credit-card p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('human_resources');?><span class="fa arrow"></span></span></a>
...
<!-- <li> <a href="#" class=""<i data-icon="&#xe006;"></i> <span class="hide-menu"><i class="fa fa-university p-r-10"></i><?php echo get_phrase('recruitment');?><span class="fa arrow"></span></span></a>
                                <ul class=" nav nav-second-level">
...
<li> <a href="#" class=""<i data-icon="&#xe006;"></i> <span class="hide-menu"><i class="fa fa-university p-r-10"></i><?php echo get_phrase('payroll');?><span class="fa arrow"></span></span></a>
                                <ul class=" nav nav-second-level">
                 ...
                 <!-- </ul>
                    ...
                    <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-fax p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('expenses');?><span class="fa arrow"></span></span></a>
        ...
        <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-book p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_library');?><span class="fa arrow"></span></span></a>
        ...
        <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('hostel_information');?><span class="fa arrow"></span></span></a>
            <ul class=" nav nav-second-level<?php
           ...
           <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-envelope p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('communications');?><span class="fa arrow"></span></span></a>
        ...
        <li class="<?php if ($page_name == 'sendSMSMessage') echo 'active'; ?> ">
            ...
            <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-car p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('transportation');?><span class="fa arrow"></span></span></a>
        ...
        <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-gears p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('system_settings');?><span class="fa arrow"></span></span></a>
...
<!--
        ...
        <!-- <li> <a href="#" class=""><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('generate_reports');?><span class="fa arrow"></span></span></a>
