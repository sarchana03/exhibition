<div class="row">
               ...
               <div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
							<button type="submit" class="btn btn-success btn-block btn-sm btn-rounded"> <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_material');?></button>
					</div>
					<br>
                <?php echo form_close();?>	
...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    ...
    <?php $counter = 1; $material = $this->db->get('material')->result_array();
            ...
            <tr>
                ...
                <td><?php echo $this->db->get_where('doctor', array('doctor_id' => $material['doctor_id']))->row()->name;?></td>
                <td><?php echo $this->db->get_where('patient', array('patient_id' => $material['patient_id']))->row()->name;?></td>
