...
<div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">EDIT HEALTH TIP</div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('patient');?></label>
                    <div class="col-sm-12">
                    ...
                    <option value="<?php echo $patient['patient_id'];?>"<?php if($material['patient_id'] == $patient['patient_id']) echo 'selected';?>><?php echo $patient['name'];?></option>
                    <?php endforeach;?>
                   </select>
					   ...
					   <select name="doctor_id" class="form-control select2" style="width:100%;" required>
                           ...
                           <?php $doctor =  $this->db->get('doctor')->result_array();
                                    foreach($doctor as $key => $doctor):?>         	
                                    		<option value="<?php echo $doctor['doctor_id'];?>"<?php if($material['doctor_id']== $doctor['doctor_id']) echo 'selected';?>><?php echo $doctor['name'];?></option>
                            <?php endforeach;?>
