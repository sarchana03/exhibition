    <!-- Left navbar-header -->
     ...
     <!---  Permission for Admin Dashboard starts here ------>
        ...
        <?php if($check_admin_permission == '1'):?>
            <li> <a href="<?php echo base_url();?>superadmin/dashboard" class=""><i class="ti-dashboard p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Dashboard') ;?></span></a> </li>
        <?php endif;?> 
    <!---  Permission for Admin Dashboard ends here ------>
        ...
        <span class="hide-menu"><?php echo get_phrase('live_class');?></span>
    </a>
        </li>    
